...
const includeRelation = async (list: string[], model: Model<any>, table: string, key: string, as: string, scope?: ModelQuery<any>) => {
...
export const include = async (list: string[], model: Model<any>, table: string, args: any[]) => {
